...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    point = generate_points_on_circle(circle,number_of_points)
...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(350, 200), 160)
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow(550, 400, title)
    circle = rg.Circle(rg.Point(350, 250), 150)
...
def run_test_fancy_polygon():
    ...
    window = rg.RoseWindow(640, 480, title)

    circle = rg.Circle(rg.Point(320, 205), 150)
...
def fancy_polygon(window, circle, number_of_lines, hops_to_next_point, color,
    ...
    # -------------------------------------------------------------------------
    circle.attach_to(window)
    points = generate_points_on_circle(circle,number_of_lines*2)
    for k in range(0,len(points)):
        if number_of_lines+hops_to_next_point <= number_of_lines:
            line = rg.Line(points[k],points[k+hops_to_next_point])
        else:
            line = rg.Line(points[k],points[abs(number_of_lines-(k+hops_to_next_point))])
        line.color = color
        line.thickness = thickness
        line.attach_to(window)
    window.render()
